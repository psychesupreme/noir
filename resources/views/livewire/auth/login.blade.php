            ...
            <div class="flex items-center justify-between">
                <label class="flex items-center gap-2.5 cursor-pointer select-none group">
                    <input
                        type="checkbox"
                        wire:model="remember"
                        :class="theme === 'champagne' ? 'border-neutral-300 bg-white text-black' : 'border-neutral-700 bg-[#0F0F12] text-white'"
                        class="w-3.5 h-3.5 rounded-sm focus:ring-0 focus:ring-offset-0 cursor-pointer accent-current"
                    >
                    <span 
                        :class="theme === 'champagne' ? 'text-neutral-500 group-hover:text-neutral-800' : 'text-neutral-500 group-hover:text-neutral-400'"
