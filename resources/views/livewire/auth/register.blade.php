    ...
    <div class="space-y-8">
        ...
        <form wire:submit.prevent="register" class="space-y-5">
            ...
            <div class="space-y-2">
                ...
                <div 
                    :class="theme === 'champagne' ? 'bg-neutral-200/50 border-neutral-300' : 'bg-[#0A0A0A] border-neutral-800'"
                ...
                >
                    <button
                        ...
                        :class="{
                            'bg-neutral-950 text-white font-bold shadow-sm': $account_type === 'retail' && theme === 'champagne',
                            'bg-white text-black font-bold shadow-sm': $account_type === 'retail' && theme !== 'alabaster',
                            'text-neutral-500 hover:text-neutral-800': $account_type !== 'retail' && theme === 'champagne',
                    ...
                    <button
                        ...
                        :class="{
                            'bg-neutral-950 text-white font-bold shadow-sm': $account_type === 'corporate' && theme === 'champagne',
                            'bg-white text-black font-bold shadow-sm': $account_type === 'corporate' && theme !== 'alabaster',
                            'text-neutral-500 hover:text-neutral-800': $account_type !== 'corporate' && theme === 'champagne',
            ...
            <div class="space-y-2">
                ...
                <input
                    ...
                    autocomplete="name"
                    :class="theme === 'champagne' ? 'bg-white border-neutral-300 text-neutral-900 placeholder-neutral-400 focus:border-neutral-500' : 'bg-[#0F0F12] border-neutral-800 text-white placeholder-neutral-600 focus:border-neutral-600'"
            ...
            <div class="space-y-2" x-data="{ showPassword: false }">
                <div class="flex items-center justify-between">
                    ...
                    <button
                        ...
                        :class="theme === 'champagne' ? 'text-neutral-500 hover:text-neutral-800' : 'text-neutral-600 hover:text-neutral-400'"
        ...
        <div class="text-center">
            <p :class="theme === 'champagne' ? 'text-neutral-500' : 'text-neutral-600'" class="text-[11px] font-light transition-colors">
                ...
                <a 
                    href="/login" 
                    wire:navigate 
                    :class="theme === 'champagne' ? 'text-neutral-900 hover:text-black decoration-neutral-300 hover:decoration-neutral-500' : 'text-white/70 hover:text-white decoration-neutral-700 hover:decoration-neutral-500'"
