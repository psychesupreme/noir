...
class Product extends Model
{
    ...
    public function getAverageRatingAttribute(): float
    {
        if (array_key_exists('reviews_avg_rating', $this->attributes)) {
            return (float) round($this->attributes['reviews_avg_rating'] ?: 0, 1);
        }
        return \Illuminate\Support\Facades\Cache::remember('product_avg_rating_' . $this->id, 86400, function() {
    ...
    {
        if (array_key_exists('reviews_avg_quality_rating', $this->attributes)) {
            return (float) round($this->attributes['reviews_avg_quality_rating'] ?: 0, 1);
        }
        return \Illuminate\Support\Facades\Cache::remember('product_avg_quality_rating_' . $this->id, 86400, function() {
    ...
    {
        if (array_key_exists('reviews_avg_freshness_rating', $this->attributes)) {
            return (float) round($this->attributes['reviews_avg_freshness_rating'] ?: 0, 1);
        }
        return \Illuminate\Support\Facades\Cache::remember('product_avg_freshness_rating_' . $this->id, 86400, function() {
    ...
    {
        if (array_key_exists('reviews_avg_value_rating', $this->attributes)) {
            return (float) round($this->attributes['reviews_avg_value_rating'] ?: 0, 1);
        }
        return \Illuminate\Support\Facades\Cache::remember('product_avg_value_rating_' . $this->id, 86400, function() {
