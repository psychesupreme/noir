...
class SeoAndSocialMetadataTest extends TestCase
{
    ...
    public function test_storefront_contains_seo_and_open_graph_meta_tags(): void
    {
        ...
        $response->assertSee("Explore Atelier Noir & Bloom's premium floral curations", false);

        // Assert Open Graph tags are present
        $response->assertSee('property="og:title" content="Atelier Noir & Bloom | Premium Floral Curations &amp; Luxury Gifting Atelier"', false);
        ...
        $response->assertSee('"name": "Atelier Noir & Bloom"', false);
        ...
        $response->assertSee('class="sr-only">Atelier Noir & Bloom | Premium Floral Curations &amp; Luxury Gifting Atelier</h1>', false);
    }
    ...
    public function test_services_page_contains_specific_seo_and_business_schemas(): void
    {
        ...
        $response->assertSee('property="og:title" content="Bespoke Services &amp; Luxury Gifting Suites | Atelier Noir & Bloom"', false);

        // Assert LocalBusiness Schema JSON-LD is loaded
        $response->assertSee('"@type": "LocalBusiness"', false);
        $response->assertSee('Atelier Noir & Bloom - Nairobi Branch', false);
        $response->assertSee('Atelier Noir & Bloom - Kiambu Branch', false);
